        ...
        !(function () {
            ...
            function w(t) {
                if (t.sequence) {
                    ...
                    return (
                        e.active && !e.blocked && !t.revealing && !t.disabled
                    );
                }
            ...
            function S(t) {
                ...
                return (
                    ...
                    (function () {
                        return (
                            "fixed" ===
                            window.getComputedStyle(t.domEl).position
                        );
                    })()
                );
            }
            ...
            (o.prototype.defaults = {
                ...
                (o.prototype.sync = function () {
                    if (N.history.length && N.isSupported()) {
                        ...
                        console.log(
                            "ScrollReveal: sync failed, no reveals found."
                        );
                    return N;
                }),
            ...
            +(function (t) {
                ...
                (e.prototype.listen = function () {
                    ...
                    (e.prototype._touchMove = function (e) {
                        Math.abs(
                            e.touches[0].pageY - this._initialTouchPosition
                        ) > 10 &&
                            (this._activeZoomClose(),
        ...
        !(function (e, n) {
            ...
            function _(t, e, n, i) {
                ...
                if (
                    ...
                    for (
                        a = yt.map(T(o, "script"), D), l = a.length;
                        f < d;
                        f++
                    )
                        (c = o),
                                  ...
                                  (o(function (t) {
                                      (I.appendChild(t).innerHTML =
                                          ...
                                          t.querySelectorAll(":checked")
                                              .length || _.push(":checked"),
                                          t.querySelectorAll("a#" + P + "+*")
                                              .length || _.push(".#.+[+~]");
                                  }),
                                  o(function (t) {
                                      t.innerHTML =
            ...
            yt.ajaxSetup({
                ...
                yt.ajaxPrefilter("json jsonp", function (t, e, i) {
                    ...
                    if (a || "jsonp" === t.dataTypes[0])
                        return (
                            (o = t.jsonpCallback = yt.isFunction(
                                t.jsonpCallback
                            )
                                ? t.jsonpCallback()
                                : t.jsonpCallback),
            ...
            +(function (t) {
                ...
                (n.VERSION = "3.3.7"),
                    ...
                    (n.prototype.slide = function (e, i) {
                        ...
                        if (
                            (this.$element.trigger(u), !u.isDefaultPrevented())
                        ) {
                            if (
                                ((this.sliding = !0),
                                s && this.pause(),
